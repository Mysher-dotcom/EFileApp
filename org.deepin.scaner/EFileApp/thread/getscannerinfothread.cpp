...
void GetScannerInfoThread::slotGetDevicePar()
{
    ...
    for (int i=0;i<_devIndexList.size();i++)
    {
       ...
       */
        ...
        qDebug()<<"sane thread GetCapCount:"<<nResult<<",cap count:"<<nCapCount;
