...
int main(int argc, char *argv[])
{
    ...
    a.loadTranslator();
    a.setOrganizationName("scanner");
    a.setApplicationVersion(DApplication::buildVersion("5.1.0.3-4"));
   // a.setApplicationAcknowledgementPage("http://www.viisan.com");
    a.setProductIcon(QIcon(":/img/logo/logo-16.svg"));
    a.setProductName("scanner");
    a.setApplicationName("scanner"); //只有在这儿修改窗口标题才有效
