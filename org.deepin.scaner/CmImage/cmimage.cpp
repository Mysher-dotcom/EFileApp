...
{
	Mat mat_src = CAdapter::mimg2Mat(src);
	//Mat mat_dst = CBookStretch::GradientAdaptiveThreshold(mat_src,2.0);
	//Mat bw1 = CBookStretch::HistAdaptiveThreshold(mat_src);
	
    Mat bw2 = CBookProcess::GradientAdaptiveThreshold(mat_src,2.0);
	bw2 =  CBookProcess::bwlabel(bw2,50);
    Mat mat_dst;
    //bitwise_or(bw1,bw2,mat_dst);
	MImage* dst = CAdapter::Mat2mimg(bw2);
	return dst;
}
...
{
	Mat mat_src = CAdapter::mimg2Mat(src);
	Mat mat_dst = CBookProcess::HistAdaptiveThreshold(mat_src,true);
	MImage* dst = CAdapter::Mat2mimg(mat_dst);
	return dst;
}
